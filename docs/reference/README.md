...
Aquí están los PDFs que acompañan al repositorio. El grupo `supplemental/` conserva documentos que originalmente estaban bajo subdirectorios de `table&/mtr/important`.
